...
# Then iterate over the last five numbers to build another
# list with the ratio of each number to its predecessor.
...
print("Last Fivenumbers", ratio_list)

print("Observations about the ratio list is that starting to converge onto Phi, the Golden Ratio")